...
public class PR11ShopMenu {
    ...
    public static void main(String[] args) {
        PR11ShopMenu sm = new PR11ShopMenu();
    ...
    public void addNewValue(PR11ShopMenu sm)
    {
    ...
    public void editValue(PR11ShopMenu sm)
    {
    ...
    public void deleteValue(PR11ShopMenu sm) {
